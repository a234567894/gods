...
func TestSetNew(t *testing.T) {
	set := NewWithIntComparator[int](2, 1)
...
func TestSetAdd(t *testing.T) {
	...
	if actualValue, expectedValue := strings.Trim(strings.Replace(fmt.Sprint(set.Values()), " ", "", -1), "[]"), "123"; actualValue != expectedValue {
...
func TestSetFind(t *testing.T) {
	...
	if foundValue != *new(string) || foundIndex != -1 {
